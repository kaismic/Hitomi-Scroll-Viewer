    ...
    public sealed partial class MainWindow : Window {
        ...
        private MainWindow() {
            ...
            _ = Task.Run(async () => {
                ...
                vm.SetStatusMessage(LoadProgressReporterVM.LoadingStatus.InitialisingDatabase);
                bool dbCreatedFirstTime = HitomiContext.Main.Database.EnsureCreated();
                if (dbCreatedFirstTime) {
                    vm.IsIndeterminate = false;
                    vm.ProgressBarValue = 0;
                    vm.ProgressBarMaximum = HitomiContext.DATABASE_INIT_OP_NUM;
                    HitomiContext.Main.DatabaseInitProgressChanged += (_, value) => {
                        DispatcherQueue.TryEnqueue(() => vm.ProgressBarValue = value);
                    };
                ...
                if (v2TagFilterExists) {
                    vm.IsIndeterminate = false;
                    vm.ProgressBarValue = 0;
                    vm.SetStatusMessage(LoadProgressReporterVM.LoadingStatus.MigratingTFSs);
                    ...
                    vm.ProgressBarMaximum = tagFilterV2.Count;
                ...
                if (!v2TagFilterExists && dbCreatedFirstTime) {
                    vm.IsIndeterminate = true;
                    vm.SetStatusMessage(LoadProgressReporterVM.LoadingStatus.AddingExampleTFSs);
                ...
                if (Directory.Exists(IMAGE_DIR_V2)) {
                    ...
                    vm.IsIndeterminate = true;
                    vm.SetStatusMessage(LoadProgressReporterVM.LoadingStatus.MovingImageFolder);
                ...
                vm.IsIndeterminate = false;
                vm.ProgressBarValue = 0;
                vm.ProgressBarMaximum = 4;
                vm.SetStatusMessage(LoadProgressReporterVM.LoadingStatus.LoadingDatabase);
                ...
                vm.IsIndeterminate = true;
                vm.SetStatusMessage(LoadProgressReporterVM.LoadingStatus.InitialisingApp);
                SearchPageVM = new();
                BrowsePageVM = new();
                ViewPageVM = new();
