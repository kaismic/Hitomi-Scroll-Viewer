...
### Note (14/03/2025): Currently, the app is under the process of a complete re-design and refactoring for a new web browser-based app and I do NOT recommend downloading the currently released version (v2.1.1)
